...
# --
# -- Combine patient level data with ADT code
# --

# CREATE OR REPLACE TEMPORARY VIEW ML_PATIENT_VIEW AS (
#   WITH _PATIENT_0 AS (
#       SELECT bundleUUID,
#              timestamp,
#              id,
#              -- each patient bundle only has 1 element
#              patient_id,
#              patient
#       FROM ml_demos.redox_himss.patient_train
#     ),
#     _PATIENT_1 AS (
#         SELECT bundleUUID,
#                timestamp,
...
#                patient_id,
#                patient,
#                explode(patient.identifier) as identifier
#         FROM _PATIENT_0
#     ),
#     _PATIENT_2 AS (
#         SELECT bundleUUID,
...
#                patient,
#                identifier,
#                row_number() over (partition by bundleUUID, patient ORDER by timestamp) as ranks
#         FROM _PATIENT_1
#     ),
#     _PATIENT_3 AS (
#         SELECT bundleUUID,
...
#                timestamp,
#                id,
#                explode(MessageHeader) as MessageHeader
#         FROM ml_demos.redox_himss.messageheaders_train
#     )
#     SELECT _PATIENT_3.patient_id,
#            _MESSAGE_HEADER.MessageHeader.eventCoding.code as ADT_code,
#            _PATIENT_3.bundleUUID,
#            _PATIENT_3.timestamp,
#            _PATIENT_3.id,
#            _PATIENT_3.patient,
#            _MESSAGE_HEADER.MessageHeader
#     FROM _PATIENT_3
#     INNER JOIN _MESSAGE_HEADER
#       ON _PATIENT_3.bundleUUID = _MESSAGE_HEADER.bundleUUID
# );
